...
/// RAII guard that decrements the active-connections gauge when dropped.
/// Created after a MITM session is accepted; ensures `connection_closed()`
/// runs even if the serving loop returns early via `?`.
#[allow(dead_code)]
    ...
    http1::Builder::new()
        ...
        .serve_connection(
            ...
            service_fn(move |req: hyper::Request<hyper::body::Incoming>| {
                ...
                let signing_key = Arc::clone(&vti_signing_key);
                async move {
