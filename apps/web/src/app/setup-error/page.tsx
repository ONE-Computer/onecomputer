...
const errors: Record<string, { title: string; description: React.ReactNode }> =
  {
    "oauth-misconfigured": {
      ...
      description: (
        <p>
          <Code>NEXTAUTH_SECRET</Code> is set but no OAuth provider is fully
          configured. Provide either Google (<Code>GOOGLE_CLIENT_ID</Code> +{" "}
          <Code>GOOGLE_CLIENT_SECRET</Code>) or Microsoft Entra ID (
          <Code>AZURE_AD_CLIENT_ID</Code> + <Code>AZURE_AD_CLIENT_SECRET</Code>{" "}
          + <Code>AZURE_AD_TENANT_ID</Code>), or remove{" "}
