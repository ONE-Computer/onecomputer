...
export const AUDIT_ACTIONS = {
  ...
  CLAIM: "claim",
  // Manager approval gate: a manager approves or denies a held agent action.
  APPROVE: "approve",
  DENY: "deny",
  // Kill switch: instantly revoke an agent's access token so it can no longer
  // authenticate to the gateway. Paired with the CISO console revoke endpoint.
  REVOKE: "revoke",
} as const;
...
export const AUDIT_SERVICES = {
  ...
  BUDGET: "budget",
  // Manager approval gate: pending approval requests created/decided.
  APPROVAL: "approval",
} as const;
