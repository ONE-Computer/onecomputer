        ...
        <>
          ...
          <div className="w-full max-w-sm rounded-2xl border border-border/50 bg-card p-8">
            <div className="flex flex-col gap-3">
              {authMethod === "openvtc" ? (
                <Button
                  ...
                  loading={signingIn === "openvtc"}
                  disabled={signingIn !== null}
                  onClick={() => {
                    setSigningIn("openvtc");
                    void signIn().catch(() => setSigningIn(null));
                  }}
                >
                  {signingIn === "openvtc"
                    ? "Waiting for wallet..."
                    : "Continue with OpenVTC Wallet"}
                </Button>
              ) : (
                <Button
                  size="lg"
            ...
            <p className="text-muted-foreground mt-4 text-center text-xs">
              By continuing, you acknowledge ONEComputer&apos;s{" "}
              <a
