...
export const queryKeys = {
  ...
  invgini: {
    all: () => ["invgini", ...scope()] as const,
    agents: () => [...queryKeys.invgini.all(), "agents"] as const,
    evidencePack: (principalId: string) =>
      [...queryKeys.invgini.all(), "evidence-pack", principalId] as const,
    eventLogs: (principalId: string) =>
      [...queryKeys.invgini.all(), "event-logs", principalId] as const,
  },
  secrets: {
  ...
  policyArtifacts: {
    all: () => ["policy-artifacts", ...scope()] as const,
    sample: () => [...queryKeys.policyArtifacts.all(), "sample"] as const,
  },
  connections: {
  ...
  sandboxes: {
    all: () => ["sandboxes", ...scope()] as const,
    counts: () => [...queryKeys.sandboxes.all(), "counts"] as const,
  },
  vaults: {
  ...
  activity: {
    ...
    blocked24h: () => [...queryKeys.activity.all(), "blocked24h"] as const,
  },
  appBlocklist: {
